...
/**
 * Shared E2E tests for Segment Analytics React Native
 * These tests work across different React Native versions
 */
export const runAnalyticsTests = (appName = 'AnalyticsReactNativeE2E') => {
  describe('Segment Analytics E2E Tests', () => {
    ...
    it('checks that the context is set properly', async () => {
      ...
      expect(context.app.name).toBe(appName);
